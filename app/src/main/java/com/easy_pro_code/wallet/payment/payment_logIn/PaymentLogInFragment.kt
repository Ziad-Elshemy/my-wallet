package com.easy_pro_code.wallet.payment.payment_logIn
...
import com.easy_pro_code.wallet.AuthFlow.Presentation.Login.LoginFragmentDirections
...
class PaymentLogInFragment : AuthenticationFragment() {
        ...
        override fun onCreateView(
            ...
            binding.haveAnAccount.isVisible=false
...
//                        findNavController().navigate(R.id.action_loginFragment_to_signUpFragment)
        ...
        override fun successState(verificationId: String , token: PhoneAuthProvider.ForceResendingToken) {
            ...
            val action = PaymentLogInFragmentDirections.actionPaymentLogInFragmentToPaymentOtpFragment(userData,phoneData)
